    ...
    <div className="flex flex-col gap-y-4">
      <Tabs defaultValue="summary">
        <div className="bg-background rounded-lg border px-3">
          <ScrollArea>
            <TabsList className="p-0 bg-gray-500/50 justify-start rouned-none h-13">
              <TabsTrigger
                value="summary"
        ...
        <TabsContent value="recording">
          <div className="bg-white rounded-lg border px-4 py-5">
            {data.recordingUrl ? (
              ...
              <div className="text-center py-4">No recording found</div>
            )}
          </div>
        </TabsContent>
        <TabsContent value="summary">
          <div className="bg-background rounded-lg border">
            <div className="px-4 py-5 gap-y-5 flex flex-col col-span-5">
              <h2 className="text-2xl font-medium capitalie">{data.name}</h2>
              <div
              ...
              <div>
                <Markdown
                  components={{
                    ...
                    ul: (props) => (
                      <ul className="list-dsic list-inside mb-6" {...props} />
                    ),
                    ol: (props) => (
                      <ol
