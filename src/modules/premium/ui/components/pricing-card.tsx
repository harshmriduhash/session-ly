...
const pricingCardVariants = cva("rounded-lg p-4 py6 w-full", {
  variants: {
    variant: {
      default: "bg-white text-black",
      highlighted: "bg-linear-br from-[#000000] to-[#22222A]",
    },
  },
  defaultVariants: {
    variant: "default",
...
const pricingCardSecondaryTextVariants = cva("text-neutral-700", {
  variants: {
    variant: {
      ...
      highlighted: "text-neutral-700 dark:text-neutral-300",
    },
  },
});
